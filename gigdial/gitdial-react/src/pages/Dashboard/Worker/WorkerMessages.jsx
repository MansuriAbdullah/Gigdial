            ...
            <div className="w-1/3 border-r border-slate-100 flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto">
                    {conversations.map((user) => (
                        ...
                        >
                            <div className="relative">
                                <img src={user.profileImage || "https://i.pravatar.cc/150?img=11"} alt={user.name} className="w-12 h-12 rounded-full object-cover" />
                    ...
                    <>
                        ...
                        <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-white z-10">
                            <div className="flex items-center gap-3">
                                <div className="relative">
                                    <img src={activeChat.profileImage || "https://i.pravatar.cc/150?img=11"} alt={activeChat.name} className="w-10 h-10 rounded-full object-cover" />
                            ...
                            {messages.map((msg, idx) => {
                                ...
                                return (
                                    <div key={msg._id || idx} className={`flex gap-3 max-w-[80%] ${isMe ? 'self-end flex-row-reverse' : ''}`}>
                                        <img
                                            src={isMe ? (userInfo.profileImage || "https://i.pravatar.cc/150?img=11") : (activeChat.profileImage || "https://i.pravatar.cc/150?img=11")}
                                            alt=""
