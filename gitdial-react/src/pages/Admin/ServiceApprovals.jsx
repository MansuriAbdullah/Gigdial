        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-2">Manage service categories and approve worker requests.</p>
                </div>
                <div className="flex bg-slate-100 p-1 rounded-xl">
                    ...
                    >
                        Approvals
                        {services.length > 0 && <span className="ml-2 bg-blue-100 text-blue-600 px-1.5 py-0.5 rounded text-xs">{services.length}</span>}
                    </button>
                    <button
            ...
            {activeTab === 'approvals' ? (
                ...
                <div className="space-y-6">
                    <div className="flex justify-end">
                        <button className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-xl font-bold hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/20">
